...
class InfluencerManagerApp:
    ...
    def register_influencer(self, influencer_type: str, username: str, followers: int, engagement_rate: float):
        ...
        influencer = self._get_object_by_username(self.influencers, username)
        if influencer:
    ...
    def create_campaign(self, campaign_type: str, campaign_id: int, brand: str, required_engagement: float):
        ...
        campaign = self._get_object_by_id(self.campaigns, campaign_id)
        if campaign:
    ...
    def participate_in_campaign(self, influencer_username: str, campaign_id: int):
        influencer = self._get_object_by_username(self.influencers, influencer_username)
        if not influencer:
        ...
        for influencer in self.influencers:
            for campaign in influencer.campaigns_participated:
                ...
                if total_followers > 0:
                    if campaign not in reached_followers:
                        reached_followers[campaign] = 0
    ...
    @staticmethod
    def _get_object_by_id(object_list, id_):
