...
class BaseCampaign(ABC):
    ...
    def __init__(self, campaign_id: int, brand: str, budget: float, required_engagement: float):
        ...
        self.approved_influencers = [] # Will be storing influencers objects for the campaign if they meet the eligibility criteria.
